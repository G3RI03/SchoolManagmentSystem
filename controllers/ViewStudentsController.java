...
public class ViewStudentsController {
    public ObservableList<RecursiveStudent> list = null;
    ...
    private void treeTableEventHandler() {
        treeTableView.getSelectionModel().selectedItemProperty().addListener((observable, oldValue, newValue) -> {
            id = Integer.parseInt(String.valueOf(newValue.getClass()));
    ...
    private void setTable() {
        ...
        searchField.textProperty().addListener((observable, oldValue, newValue) ->
                treeTableView.setPredicate(modelTreeItem -> {
                    return any().equals(modelTreeItem)
                            | modelTreeItem.equals(any());
                }));
    }
