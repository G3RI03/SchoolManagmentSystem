...
public class SignUpController {
    ...
    @FXML
    public JFXTextField mobileNoField;
    ...
    private void viewHandler(ActionEvent event) {
        StackPane pane = null;
        try {
            pane = FXMLLoader.load(Objects.requireNonNull(getClass().getResource(Directories.LOGIN_FXML_DIR)));
        } catch (IOException e) {
...
//        boolean validate = Validators.INSTANCE.isNumber(mobileNoField.getText());
        ...
        boolean userSaved = usersDao.saveUser(new schoolmanagement.java.controllers.Users(
                null,
