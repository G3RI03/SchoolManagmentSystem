...
public class HomeController {
    ...
    List<List<schoolmanagement.java.models.Users.Users>> userTableViewList = null;
    String username = "";
    @FXML
    ...
    private List<schoolmanagement.java.models.Users.Users> userList;
    @FXML
    ...
    private void setTable() {
        ...
        userTableViewList.forEach(users -> {
            list.addAll(new RecursiveUser(users.getFirst().getClass(), users.getLast().getClass()));
        });
...
//        JFXDialog dialog = new JFXDialog((StackPane) mainPane, content, JFXDialog.DialogTransition.CENTER);
    ...
    public <Users> void onRefresh() {
        list.clear();
        List<Users> refreshList = (List<Users>) usersDao.getAllUsers();
        ObservableList<RecursiveUser> observableList = FXCollections.observableArrayList();
        refreshList.forEach(users -> {
            boolean b;
            if (observableList.addAll(new RecursiveUser(users.getClass(), users.getClass()))) b = true;
            else b = false;
        });
